...
public class Utils {
    public static final String TiggerRegex = "(是|为|:|：| |G-|is|)+(:|：|G-|\\[|【| |)";
    public static final String SmsRegex = "(?<![0-9a-zA-Z])([0-9a-zA-Z]{4,10})(?![0-9a-zA-Z])";
    public static final String Keyword = "(验证|校验|动态|确认|随机|激活|兑换|认证|交易|授权|操作|密码|提取|安全|verification )+(码|代码|号码|密码|code)";
